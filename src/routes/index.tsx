  ...
  head: () => ({
    meta: [
      { title: "AlgoQuest | Aprenda algoritmos jogando" },
      {
        name: "description",
        content:
          "Resolva desafios de lógica, organize sequências e aprenda algoritmos em missões interativas.",
      },
      { property: "og:title", content: "AlgoQuest | Aprenda algoritmos jogando" },
      {
        property: "og:description",
        content: "Uma aventura interativa para aprender lógica e algoritmos passo a passo.",
      },
